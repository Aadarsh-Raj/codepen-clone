...
if(prevValue){
  ...
  return (
    <div className={`sidebar ${!userCtx.toggleSidebar ? 'sidebar-open' : ""}`} >
      ...
      <div className="editor-link-btn">Start Coding </div></Link>
     
     
      <div className="toggle-sidebar" onClick={hideSidebar}>
        <svg viewBox="-122.9 121.1 105.9 61.9" width="20" height="20" style={{transform:userCtx.toggleSidebar ? `rotate(90deg)`: `rotate(-90deg)`}}>
